    ...
    e.extend(j.prototype, {
        ...
        _attach: function(c) {
            var b = this.s.dt,
                ...
                d = this.dom.handle,
                f = this.s.handle,
                g = e("div.dataTables_scrollBody", this.s.dt.table().container());
            if (!a || -1 === b.columns(this.c.columns).indexes().indexOf(a.column)) this._detach();
                ...
                d.css({
                    top: b.top + c.offsetHeight - f.height + g.scrollTop(),
                    left: b.left +
                        c.offsetWidth - f.width + g.scrollLeft()
        ...
        _actionSelector: function(c) {
            ...
            if (1 === f.length && !1 === this.c.alwaysAsk) {
                ...
                e.each(f, function(f, g) {
                    h.append(e("<li/>").append('<div class="dt-autofill-question">' + d[g].option(a, c) + "<div>").append(e('<div class="dt-autofill-button">').append(e('<button class="' +
                        j.classes.btn + '">' + a.i18n("autoFill.button", "&gt;") + "</button>").on("click", function() {
                        var f = d[g].execute(a, c, e(this).closest("li"));
                        b._update(f, c);
        ...
        _drawSelection: function(c) {
            ...
            if (b.cell(f).any() && -1 !== b.columns(this.c.columns).indexes().indexOf(g.column)) {
                this.s.end = g;
                var h, b = a.row < g.row ? d : f;
                h = a.row < g.row ? f : d;
                c = a.column < g.column ? d : f;
                d = a.column < g.column ? f : d;
                b = b.position().top;
                c = c.position().left;
        ...
        _editor: function(c) {
            var b = this.s.dt,
                a = this.c.editor;
            if (a) {
                for (var d = {}, f = [], e = a.fields(), h = 0, i = c.length; h < i; h++)
                    for (var j = 0, l = c[h].length; j < l; j++) {
                        var n = c[h][j],
        ...
        _mousedown: function(c) {
            ...
            e(i.body).on("mousemove.autoFill",
                function(a) {
                    b._mousemove(a)
        ...
        _mouseup: function() {
            ...
            if (!(b.row === a.row && b.column === a.column)) {
                for (var d = this._range(b.row, a.row), b = this._range(b.column, a.column), a = [], f = c.settings()[0], g = f.aoColumns,
                    h = 0; h < d.length; h++) a.push(e.map(b, function(a) {
                    var a = c.cell(":eq(" + d[h] + ")", a + ":visible", {
                            page: "current"
                        }),
                        b = a.data(),
                        e = a.index(),
                        i = g[e.column].editField;
        ...
        _shiftScroll: function(c) {
            ...
            h || j || k || l ? (a.windowVert = h, a.windowHoriz = j, a.dtVert = k, a.dtHoriz = l, d = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null);
            !this.s.scrollInterval &&
                d && (this.s.scrollInterval = setInterval(function() {
        ...
        _update: function(c, b) {
            if (!1 !== c) {
                ...
                if (null !== this.c.update ? this.c.update : !this.c.editor) {
                    for (var f = 0, e =
                        b.length; f < e; f++)
                        for (var h = 0, i = b[f].length; h < i; h++) d = b[f][h], d.cell.data(d.set);
                    a.draw(!1)
                }
        ...
        increment: {
            ...
            execute: function(c, b, a) {
                for (var c = 1 * b[0][0].data, a = 1 * e("input", a).val(), d = 0, f = b.length; d < f; d++)
                    for (var g = 0, h = b[d].length; g < h; g++) b[d][g].set = c, c += a
            }
        },
        fill: {
            available: function() {
            ...
            execute: function(c, b) {
                for (var a = b[0][0].data, d = 0, e = b.length; d < e; d++)
                    for (var g = 0, h = b[d].length; g < h; g++) b[d][g].set = a
            }
        },
        fillHorizontal: {
            available: function(c, b) {
            ...
            execute: function(c, b) {
                for (var a = 0, d = b.length; a < d; a++)
                    for (var e = 0, g = b[a].length; e < g; e++) b[a][e].set = b[a][0].data
            }
        },
        fillVertical: {
            ...
            execute: function(c, b) {
                for (var a = 0, d = b.length; a < d; a++)
                    for (var e = 0, g = b[a].length; e < g; e++) b[a][e].set = b[0][e].data
            }
        },
        cancel: {
            available: function() {
