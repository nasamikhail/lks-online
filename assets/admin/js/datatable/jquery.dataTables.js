...
(function($) {
    ...
    $.fn.snsDataTable = function(settings) {
        ...
        settings.bAutoWidth      = settings.bAutoWidth      || true
        settings.sScrollY        = settings.sScrollY        || '210px'
        //settings.sScrollY        = settings.sScrollY      || '315px'
        settings.sDom            = settings.sDom            || 'rt<"bottom"flp>'
        settings.iDisplayLength  = settings.iDisplayLength  || 15
...
(function($, window, document) {
	...
	_oExt.oPagination = {
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
            ...
            nFirst.title = "Halaman Pertama";
            nPrevious.title = "Halaman Sebelumnya";
            nNext.title = "Halaman Berikutnya";
            nLast.title = "Halaman Terakhir";
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfoEmpty": "Menampilkan 0 to 0 of 0 items",
